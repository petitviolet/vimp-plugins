(function() {
  ...
  function makeMarkdownString(window, url) {
    var selection = getUserSelection(window);
    var markdown = "";
  ...
  function getUserSelection(_window) {
    var selection = new XPCNativeWrapper(_window.content.window).getSelection().toString().trim();
    return selection;
  }
